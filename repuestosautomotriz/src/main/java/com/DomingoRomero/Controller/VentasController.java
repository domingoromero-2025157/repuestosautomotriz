...
public class VentasController {
    ...
    @PostMapping
    public ResponseEntity<?> createVentas(@Valid @RequestBody Ventas ventas) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> upadateVentas(@PathVariable Integer id, @RequestBody Ventas ventas) {

        try {
            Ventas actualizado = ventasService.upadateVentas(id, ventas);
